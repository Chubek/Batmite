...
Float32 f32Addition(Float32 a, Float32 b) {
    ...
    uint32_t mantissa_a = (a.fraction | 0x800000) << 7; 
    uint32_t mantissa_b = (b.fraction | 0x800000) << 7; 
    int exponent_a = a.exponent - 127;
    int exponent_b = b.exponent - 127;
...
Float32 f32Multiplication(Float32 a, Float32 b) {
    ...
    uint32_t mantissa_a = a.fraction | 0x800000; 
    uint32_t mantissa_b = b.fraction | 0x800000; 
    int exponent_a = a.exponent - 127;
    int exponent_b = b.exponent - 127;
...
Float64 f64Addition(Float64 a, Float64 b) {
    ...
    uint64_t mantissa_a = (a.fraction | 0x10000000000000); 
    uint64_t mantissa_b = (b.fraction | 0x10000000000000); 
    int exponent_a = a.exponent - 1023;
    int exponent_b = b.exponent - 1023;
    ...
    if (result.fraction & 0x10000000000000) {
        result.fraction >>= 1;
        result.exponent++;
    }
...
Float64 f64Multiplication(Float64 a, Float64 b) {
    ...
    result.exponent = a.exponent + b.exponent - 1023;
    result.sign = a.sign ^ b.sign;
